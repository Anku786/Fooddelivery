            ...
            <div class="tab-content">
                <div class="tab-pane active show">
                    <div class="list-payment-methods">
                        <div class="check-action-block-payment tab-content-ui card-active">
                            <div class="head-other-mathod">
                                <div class="block-bank-account-detail">
                                    <div class="block-content-smple">
                                        <label class="title">
                                            <img width="25" src="https://cdn.razorpay.com/app/bhim.svg" alt="Google Pay" /> 
                                            BHIM UPI
                                        </label>
                                        <div class="option-netbanking upi-block">
                                            <div class="dropdown">
                                                <input placeholder="Enter UPI ID" name="vpa" onChange={this.handleChange} type="text" /><span>@upi</span>
                                            </div>
                                            <div class="m-t20">
...
export default connect(mapStateToProps,mapDispatchToProps)(withRouter(BhimUpi))
