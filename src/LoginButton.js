...
class AllHeader extends Component {
  ...
  render(){
    ...
    return (
        <>
                <div class="buttons-block"><a href="javascript: void(0);" onClick={this.handleClick} class="btn btn1">Login</a></div>
...
const mapStateToProps = (state) => {
  ...
  export default connect(mapStateToProps,null)(AllHeader)